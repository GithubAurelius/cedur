...
<body>
    ...
    <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" id='main_form' enctype="multipart/form-data">
        ...
        <creator>
			<fieldset><legend>Beschreibung und PDF-Plan</legend>
				<div class='row'>
					<div class='col'><div class='desc_f'>Kurzbeschreibung</div><input type='text' id='F_210' name='F_210'></div>
				</div>
				<div class='row'>
					<div class='col'><div class='desc_f'>PDF-Plandateien</div><div id='src_5002'></div><div id='da_5002' class='drop-area' data-drop-area><input type='file' id='F_5002' name='F_5002[]' multiple></div><button id='button_5002' type='button'  class='filedict_button'>anzeigen</button><div id='info_5002' class='filedict_info_box' style='display: none;'></div></div>
				</div>
			</fieldset>
			<fieldset><legend>Bild PlOb</legend>
				<div class='row'>
					<div class='col'><div class='desc_f'>Bild an PlOb-System übertragen</div><input type='checkbox' id='F_220' name='F_220' value='1'></div>
				</div>
				<div class='row'>
					<div class='col'><div class='desc_f'>Bilddatei</div><div id='src_5000'></div><div id='da_5000' class='drop-area' data-drop-area><input type='file' id='F_5000' name='F_5000[]' multiple></div><button id='button_5000' type='button'  class='filedict_button'>anzeigen</button><div id='info_5000' class='filedict_info_box' style='display: none;'></div></div>
				</div>
			</fieldset></creator>
