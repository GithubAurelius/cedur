...
<body>
    ...
    <table id='main_tab'>
        <tr>
			...
			<div class='col_100' ><div id='B_10003110_Ja' class='block' style='display:none'>
				<div class='row'>
					...
					<div class='col'><div class='desc_f'>Patient verstorben </div></div><div class='col'><input  type='date' id='FF_10003017' name='FF_10003017' value="<?php echo htmlspecialchars($form_data_a[10003017] ?? ''); ?>" placeholder='Datum'></div>
					<div class='col_100 infotext'  id='SH_'><hr></div>
