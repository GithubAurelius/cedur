...
<body>
    ...
    <table id='main_tab'>
        <tr>
			...
			<fieldset id='FS_993344'><legend><img height='14px' src='../forms/images/dataentry.svg'> Anamnese</legend>
			...
			<div class='col_100' ><div id='B_102805_Ja' class='block' style='display:none'>
				<div class='row'>
                    ...
                    <div class='col_b' id='SH_102815_b'>
                        <select id='mts_102815' name='mts_102815'><option value=''></option><option value='Nein' <?php if (($form_data_a[102815] ?? '') == 'Nein') echo 'selected'; ?>>Nein</option><option value='Allergenarme Kost/ Exklusionsdiät (z.B. Nussallergie o.ä.)' <?php if (($form_data_a[102815] ?? '') == 'Allergenarme Kost/ Exklusionsdiät (z.B. Nussallergie o.ä.)') echo 'selected'; ?>>Allergenarme Kost/ Exklusionsdiät (z.B. Nussallergie o.ä.)</option><option value='Ballaststoffarm' <?php if (($form_data_a[102815] ?? '') == 'Ballaststoffarm') echo 'selected'; ?>>Ballaststoffarm</option><option value='Ballaststoffreich' <?php if (($form_data_a[102815] ?? '') == 'Ballaststoffreich') echo 'selected'; ?>>Ballaststoffreich</option><option value='Exklusive Enterale Ernährung (mit Trinknahrung)' <?php if (($form_data_a[102815] ?? '') == 'Exklusive Enterale Ernährung (mit Trinknahrung)') echo 'selected'; ?>>Exklusive Enterale Ernährung (mit Trinknahrung)</option><option value='FODMAP ( Blähungen)' <?php if (($form_data_a[102815] ?? '') == 'FODMAP ( Blähungen)') echo 'selected'; ?>>FODMAP ( Blähungen)</option><option value='Fruktosefrei/-arm' <?php if (($form_data_a[102815] ?? '') == 'Fruktosefrei/-arm') echo 'selected'; ?>>Fruktosefrei/-arm</option><option value='Gluten-frei /-arm' <?php if (($form_data_a[102815] ?? '') == 'Gluten-frei /-arm') echo 'selected'; ?>>Gluten-frei /-arm</option><option value='Zuckerverzicht' <?php if (($form_data_a[102815] ?? '') == 'Zuckerverzicht') echo 'selected'; ?>>Zuckerverzicht</option><option value='Laktosefrei/-arm' <?php if (($form_data_a[102815] ?? '') == 'Laktosefrei/-arm') echo 'selected'; ?>>Laktosefrei/-arm</option><option value='Proteinreich' <?php if (($form_data_a[102815] ?? '') == 'Proteinreich') echo 'selected'; ?>>Proteinreich</option><option value='Vegan' <?php if (($form_data_a[102815] ?? '') == 'Vegan') echo 'selected'; ?>>Vegan</option><option value='Vegetarisch' <?php if (($form_data_a[102815] ?? '') == 'Vegetarisch') echo 'selected'; ?>>Vegetarisch</option></select>
                        <input type='hidden' id='FF_102815' name='FF_102815' value="<?php echo htmlspecialchars($form_data_a[102815] ?? ''); ?>"><ul id='chosen_102815' class='cosen_select'></ul>
                    ...
                    <div class='col_b' id='SH_106000_b'>
                        <select required id='FF_106000' name='FF_106000'  onchange='follow_select(this)'><option value=''></option><option value='Angestellt tätig' <?php if (($form_data_a[106000] ?? '') == 'Angestellt tätig') echo 'selected'; ?>>Angestellt tätig</option><option value='Selbständig tätig' <?php if (($form_data_a[106000] ?? '') == 'Selbständig tätig') echo 'selected'; ?>>Selbständig tätig</option><option value='Student / Schüler / in Ausbildung' <?php if (($form_data_a[106000] ?? '') == 'Student / Schüler / in Ausbildung') echo 'selected'; ?>>Student / Schüler / in Ausbildung</option><option value='Elternzeit' <?php if (($form_data_a[106000] ?? '') == 'Elternzeit') echo 'selected'; ?>>Elternzeit</option><option value='Arbeitssuchend / Arbeitslos' <?php if (($form_data_a[106000] ?? '') == 'Arbeitssuchend / Arbeitslos') echo 'selected'; ?>>Arbeitssuchend / Arbeitslos</option><option value='Nicht berufstätig' <?php if (($form_data_a[106000] ?? '') == 'Nicht berufstätig') echo 'selected'; ?>>Nicht berufstätig</option><option value='Rentner (aufgrund CED)' <?php if (($form_data_a[106000] ?? '') == 'Rentner (aufgrund CED)') echo 'selected'; ?>>Rentner (aufgrund CED)</option><option value='Rentner (aufgrund anderer Erkrankungen)' <?php if (($form_data_a[106000] ?? '') == 'Rentner (aufgrund anderer Erkrankungen)') echo 'selected'; ?>>Rentner (aufgrund anderer Erkrankungen)</option><option value='Rentner (reguläre Altersrente)' <?php if (($form_data_a[106000] ?? '') == 'Rentner (reguläre Altersrente)') echo 'selected'; ?>>Rentner (reguläre Altersrente)</option>
                        </select>
                    </div>
			...
			<div class='col_100' ><div id='B_106000_Angestellt tätig' class='block' style='display:none'>
				<div class='row'>
                    ...
                    <div class='col_a' id='SH_106200_a'>
                        <div class='desc_f' style='padding-left:30px;'>Waren Sie seit der letzten Visite aufgrund Ihrer CED krankgeschrieben?</div>
                    </div>
			...
			<fieldset id='FS_'><legend><img height='14px' src='../forms/images/pregnacy.svg'> Schwangerschaft</legend>
			...
			<div class='col_100' ><div id='B_108500_Ja' class='block' style='display:none'>
				<div class='row'>
                    ...
                    <div class='col_b' id='SH_108700_b'>
                        <input data-fg='10010'  type='date' id='FF_108700' name='FF_108700' value="<?php echo htmlspecialchars($form_data_a[108700] ?? ''); ?>" placeholder=''>
                    </div>
			...
			<fieldset id='FS_'><legend><img height='14px' src='../forms/images/diagnosis.svg'> Diagnose und Symptome</legend>
                    ...
                    <div class='col_a' id='SH_102400_a'>
                        <div class='desc_f' >Waren Sie seit der letzten Visite wegen Ihrer CED im Krankenhaus?</div>
                    </div>
			...
			<div class='col_100' ><div id='B_102400_Ja' class='block' style='display:none'>
				<div class='row'>
                    ...
                    <div class='col_a' id='SH_102411_a'>
                        <div class='desc_f' >Haben Sie Probleme einzuschlafen?<br><font style='color:gray'>(0 für kein Problem bis 10 für schlimmste Probleme)?</font></div>
                    </div>
                    <div class='col_b' id='SH_102411_b'>
                        <select required id='FF_102411' name='FF_102411'  onchange='follow_select(this)'><option value=''></option><option value='0' <?php if (($form_data_a[102411] ?? '') == '0') echo 'selected'; ?>>0</option><option value='1' <?php if (($form_data_a[102411] ?? '') == '1') echo 'selected'; ?>>1</option><option value='2' <?php if (($form_data_a[102411] ?? '') == '2') echo 'selected'; ?>>2</option><option value='3' <?php if (($form_data_a[102411] ?? '') == '3') echo 'selected'; ?>>3</option><option value='4' <?php if (($form_data_a[102411] ?? '') == '4') echo 'selected'; ?>>4</option><option value='5' <?php if (($form_data_a[102411] ?? '') == '5') echo 'selected'; ?>>5</option><option value='6' <?php if (($form_data_a[102411] ?? '') == '6') echo 'selected'; ?>>6</option><option value='7' <?php if (($form_data_a[102411] ?? '') == '7') echo 'selected'; ?>>7</option><option value='8' <?php if (($form_data_a[102411] ?? '') == '8') echo 'selected'; ?>>8</option><option value='9' <?php if (($form_data_a[102411] ?? '') == '9') echo 'selected'; ?>>9</option><option value='10' <?php if (($form_data_a[102411] ?? '') == '10') echo 'selected'; ?>>10</option>
                        </select>
                    </div>
					
                    <div class='col_a' id='SH_102412_a'>
                        <div class='desc_f' >Haben Sie Probleme die Nacht durchzuschlafen?<br><font style='color:gray'>(0 für kein Problem bis 10 für schlimmste Schlafstörungen)?</font></div>
                    </div>
                    <div class='col_b' id='SH_102412_b'>
                        <select required id='FF_102412' name='FF_102412'  onchange='follow_select(this)'><option value=''></option><option value='0' <?php if (($form_data_a[102412] ?? '') == '0') echo 'selected'; ?>>0</option><option value='1' <?php if (($form_data_a[102412] ?? '') == '1') echo 'selected'; ?>>1</option><option value='2' <?php if (($form_data_a[102412] ?? '') == '2') echo 'selected'; ?>>2</option><option value='3' <?php if (($form_data_a[102412] ?? '') == '3') echo 'selected'; ?>>3</option><option value='4' <?php if (($form_data_a[102412] ?? '') == '4') echo 'selected'; ?>>4</option><option value='5' <?php if (($form_data_a[102412] ?? '') == '5') echo 'selected'; ?>>5</option><option value='6' <?php if (($form_data_a[102412] ?? '') == '6') echo 'selected'; ?>>6</option><option value='7' <?php if (($form_data_a[102412] ?? '') == '7') echo 'selected'; ?>>7</option><option value='8' <?php if (($form_data_a[102412] ?? '') == '8') echo 'selected'; ?>>8</option><option value='9' <?php if (($form_data_a[102412] ?? '') == '9') echo 'selected'; ?>>9</option><option value='10' <?php if (($form_data_a[102412] ?? '') == '10') echo 'selected'; ?>>10</option>
                        </select>
                    </div>
                    ...
                    <div class='col_b ' id='SH_103500_b'>
                        <input required type='number' id='FF_103500' name='FF_103500' value="<?php echo htmlspecialchars($form_data_a[103500] ?? ''); ?>" min='0' max='50' step='0.1' placeholder=''>
                    </div>
			...
			<div class='col_100' ><div id='B_111200_Ja' class='block' style='display:none'>
				<div class='row'>
                    ...
                    <div class='col_b' id='SH_115500_b'>
                        <textarea id='FF_115500' name='FF_115500' rows='3'><?php echo htmlspecialchars($form_data_a[115500] ?? ''); ?></textarea>
                    </div>
				</div>
			</div></div><!--block-->
			</fieldset>
			<fieldset id='FS_99991005'><legend><img height='14px' src='../forms/images/oparation.svg'> Operationen</legend>
                    ...
                    <div class='col_b' id='SH_106900_b'>
                        <select required id='FF_106900' name='FF_106900'  onchange='follow_select(this)'><option value=''></option><option value='Nein' <?php if (($form_data_a[106900] ?? '') == 'Nein') echo 'selected'; ?>>Nein</option><option value='1 Mal' <?php if (($form_data_a[106900] ?? '') == '1 Mal') echo 'selected'; ?>>1 Mal</option><option value='2 Mal' <?php if (($form_data_a[106900] ?? '') == '2 Mal') echo 'selected'; ?>>2 Mal</option><option value='3 Mal' <?php if (($form_data_a[106900] ?? '') == '3 Mal') echo 'selected'; ?>>3 Mal</option><option value='4 Mal' <?php if (($form_data_a[106900] ?? '') == '4 Mal') echo 'selected'; ?>>4 Mal</option><option value='5 Mal' <?php if (($form_data_a[106900] ?? '') == '5 Mal') echo 'selected'; ?>>5 Mal</option><option value='>5 Mal' <?php if (($form_data_a[106900] ?? '') == '>5 Mal') echo 'selected'; ?>>>5 Mal</option>
                        </select>
                    </div>
			<div class='col_100' ><div id='B_106900_1 Mal 2 Mal 3 Mal 4 Mal 5 Mal >5 Mal' class='block' style='display:none'>
			...
			<fieldset id='FS_99998002'><legend><img height='14px' src='../forms/images/medikation.svg'> Aktuelle CED-Medikation/ Verordnung</legend>
					<div class='col_100 infotext'  id='SH_99999002'>Bitte geben Sie die Medikamente ein, die Sie <strong>wegen Ihrer CED aktuell oder seit letzter Visite</strong> einnehmen.<br><font style='font-size:11px;color:gray'>Drücken Sie auf <label style='vertical-align:bottom'><svg xmlns='http://www.w3.org/2000/svg'  height='20px' width='20px' viewBox='0 -960 960 960' fill='#35a800ff'><path d='M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z'/></svg></label> (Hinzufügen) wenn Sie ein Medikament erfasst haben, um ein weiteres zu ergänzen oder die Eingabe zu beenden</font></div>
					<div style='width:100%'><iframe id='medikation' title='medikation' style='width:100%;border:0;'></iframe></div>
			</fieldset>
			<fieldset id='FS_99991008'><legend><img height='14px' src='../forms/images/untersuchung.svg'> Ärztliche Untersuchung</legend>
			<div class='col_100' ><div id='B_9501' class='block' style='display:none'>
                    ...
                    <div class='col_100' id='SH_101902_b' style='padding-left:40%' >
                        <div id='cbm_101902'>
                    ...
                    <div class='col_100' id='SH_101904_b' style='padding-left:40%' >
                        <div id='cbm_101904'>
                    ...
                    <div class='col_100' id='SH_101906_b' style='padding-left:40%' >
                        <div id='cbm_101906'>
                    ...
                    <div class='col_100' id='SH_101908_b' style='padding-left:40%' >
                        <div id='cbm_101908'>
                    ...
                    <div class='col_100' id='SH_101910_b' style='padding-left:40%' >
                        <div id='cbm_101910'>
			...
			<div class='col_100' ><div id='B_9504' class='block' style='display:none'>
				<div class='row'>
                    ...
                    <div class='col_b' id='SH_103800_b'>
                        <select required id='FF_103800' name='FF_103800'  onchange='follow_select(this)'><option value=''></option><option value='kein Befund vorhanden' <?php if (($form_data_a[103800] ?? '') == 'kein Befund vorhanden') echo 'selected'; ?>>kein Befund vorhanden</option><option value='normaler Befund oder inaktive Erkrankung' <?php if (($form_data_a[103800] ?? '') == 'normaler Befund oder inaktive Erkrankung') echo 'selected'; ?>>normaler Befund oder inaktive Erkrankung</option><option value='milde Colitis (Erythem, leicht spröde Schleimhaut)' <?php if (($form_data_a[103800] ?? '') == 'milde Colitis (Erythem, leicht spröde Schleimhaut)') echo 'selected'; ?>>milde Colitis (Erythem, leicht spröde Schleimhaut)</option><option value='moderate Colitis (deutliches Erythem, Erosionen, Gefässmuster verschwunden)' <?php if (($form_data_a[103800] ?? '') == 'moderate Colitis (deutliches Erythem, Erosionen, Gefässmuster verschwunden)') echo 'selected'; ?>>moderate Colitis (deutliches Erythem, Erosionen, Gefässmuster verschwunden)</option><option value='schwere Colitis (Ulzerationen, spontane Blutungen)' <?php if (($form_data_a[103800] ?? '') == 'schwere Colitis (Ulzerationen, spontane Blutungen)') echo 'selected'; ?>>schwere Colitis (Ulzerationen, spontane Blutungen)</option>
                        </select>
                    </div>
					
                    <div class='col_a' id='SH_103801_a'>
                        <div class='desc_f' >Histologische Untersuchung mit Dysplasien</div>
                    </div>
                    <div class='col_b' id='SH_103801_b'>
                        <select  id='FF_103801' name='FF_103801'  onchange='follow_select(this)'><option value=''></option><option value='Keine' <?php if (($form_data_a[103801] ?? '') == 'Keine') echo 'selected'; ?>>Keine</option><option value='Leichte' <?php if (($form_data_a[103801] ?? '') == 'Leichte') echo 'selected'; ?>>Leichte</option><option value='Mittlere' <?php if (($form_data_a[103801] ?? '') == 'Mittlere') echo 'selected'; ?>>Mittlere</option><option value='Schwere' <?php if (($form_data_a[103801] ?? '') == 'Schwere') echo 'selected'; ?>>Schwere</option><option value='Colitis assoziiertes Colon-Carcinom' <?php if (($form_data_a[103801] ?? '') == 'Colitis assoziiertes Colon-Carcinom') echo 'selected'; ?>>Colitis assoziiertes Colon-Carcinom</option><option value='Adenom assoziiertes Colon-Carcinom' <?php if (($form_data_a[103801] ?? '') == 'Adenom assoziiertes Colon-Carcinom') echo 'selected'; ?>>Adenom assoziiertes Colon-Carcinom</option>
                        </select>
                    </div>
				</div>
			</div></div><!--block-->
			...
			<div class='col_100' ><div id='B_104800_Ja' class='block' style='display:none'>
				<div class='row'>
					<div class='col_b' style='padding-left:30px;'><div class='desc_f'> ➥ Lokalisation der Stenose</div></div>
					
                    <div class='col_30' id='SH_104900_b'>
                        <div id='cbm_104900'>
                    ...
                    <div class='col_30' id='SH_104910_b'>
                        <div id='cbm_104910'>
			...
			<fieldset id='FS_99991009'><legend><img height='14px' src='../forms/images/labor.svg'> Laborergebnisse</legend>
			...
			<fieldset id='FS_99991003'><legend><img height='14px' src='../forms/images/sae.svg'> Nebenwirkungen</legend>
			...
			<fieldset id='FS_1377996'><legend>Lebensqualität (PROMIS)</legend>
                    ...
                    <div class='col_a' id='SH_119190_a'>
                        <div class='desc_f' ><table class='td_num'><tr><td>10.</td><td>Wie würden Sie Ihre Schmerzen im Allgemeinen einschätzen auf einer Skala von 0 (keine Schmerzen) bis 10 (schlimmstmögliche Schmerzen)?</td></tr></table></div>
                    </div>
                    <div class='col_b' id='SH_119190_b'>
                        <select required id='FF_119190' name='FF_119190'  onchange='follow_select(this)'><option value=''></option><option value='0' <?php if (($form_data_a[119190] ?? '') == '0') echo 'selected'; ?>>0</option><option value='1' <?php if (($form_data_a[119190] ?? '') == '1') echo 'selected'; ?>>1</option><option value='2' <?php if (($form_data_a[119190] ?? '') == '2') echo 'selected'; ?>>2</option><option value='3' <?php if (($form_data_a[119190] ?? '') == '3') echo 'selected'; ?>>3</option><option value='4' <?php if (($form_data_a[119190] ?? '') == '4') echo 'selected'; ?>>4</option><option value='5' <?php if (($form_data_a[119190] ?? '') == '5') echo 'selected'; ?>>5</option><option value='6' <?php if (($form_data_a[119190] ?? '') == '6') echo 'selected'; ?>>6</option><option value='7' <?php if (($form_data_a[119190] ?? '') == '7') echo 'selected'; ?>>7</option><option value='8' <?php if (($form_data_a[119190] ?? '') == '8') echo 'selected'; ?>>8</option><option value='9' <?php if (($form_data_a[119190] ?? '') == '9') echo 'selected'; ?>>9</option><option value='10' <?php if (($form_data_a[119190] ?? '') == '10') echo 'selected'; ?>>10</option>
                        </select>
                    </div>
			</fieldset>
			...
			<fieldset id='FS_1377997'><legend>Lebensqualität (FACIT - Fragebogen zur Einstufung der Erschöpfung)</legend>
