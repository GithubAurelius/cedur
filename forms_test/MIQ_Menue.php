        ...
        <tr>
			...
			<fieldset id='FS_'><legend>Menü-Definition</legend>
                    ...
                    <div class='col_b' id='SH_99902000_b'>
                        <input data-fg='99902' required type='text' id='FF_99902000' name='FF_99902000' value="<?php echo htmlspecialchars($form_data_a[99902000] ?? ''); ?>" placeholder=''>
                    </div>
                    ...
                    <div class='col_b' id='SH_99902001_b'>
                        <input data-fg='99902' required type='text' id='FF_99902001' name='FF_99902001' value="<?php echo htmlspecialchars($form_data_a[99902001] ?? ''); ?>" placeholder=''>
                    </div>
					...
					<div class='col infotext'><hr></div>
					
                    <div class='col_a' id='SH_99902012_a'>
                        <div class='desc_f' >WinboxID</div>
                    </div>
                    <div class='col_b' id='SH_99902012_b'>
                        <input data-fg='99902' required type='text' id='FF_99902012' name='FF_99902012' value="<?php echo htmlspecialchars($form_data_a[99902012] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902013_a'>
                        <div class='desc_f' >Arbeitsmodus</div>
                    </div>
                    <div class='col_b' id='SH_99902013_b'>
                        <input data-fg='99902'  type='text' id='FF_99902013' name='FF_99902013' value="<?php echo htmlspecialchars($form_data_a[99902013] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902015_a'>
                        <div class='desc_f' >Limit</div>
                    </div>
                    <div class='col_b' id='SH_99902015_b'>
                        <input data-fg='99902'  type='text' id='FF_99902015' name='FF_99902015' value="<?php echo htmlspecialchars($form_data_a[99902015] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902009_a'>
                        <div class='desc_f' >Position</div>
                    </div>
                    <div class='col_b' id='SH_99902009_b'>
                        <input data-fg='99902'  type='text' id='FF_99902009' name='FF_99902009' value="<?php echo htmlspecialchars($form_data_a[99902009] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902010_a'>
                        <div class='desc_f' >Form-Name</div>
                    </div>
                    <div class='col_b' id='SH_99902010_b'>
                        <input data-fg='99902'  type='text' id='FF_99902010' name='FF_99902010' value="<?php echo htmlspecialchars($form_data_a[99902010] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902020_a'>
                        <div class='desc_f' >Titel/ Überschrift</div>
                    </div>
                    <div class='col_b' id='SH_99902020_b'>
                        <input data-fg='99902'  type='text' id='FF_99902020' name='FF_99902020' value="<?php echo htmlspecialchars($form_data_a[99902020] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902011_a'>
                        <div class='desc_f' >Felder</div>
                    </div>
                    <div class='col_b' id='SH_99902011_b'>
                        <input data-fg='99902'  type='text' id='FF_99902011' name='FF_99902011' value="<?php echo htmlspecialchars($form_data_a[99902011] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_a' id='SH_99902004_a'>
                        <div class='desc_f' >Funktion</div>
                    </div>
                    <div class='col_b' id='SH_99902004_b'>
                        <input data-fg='99902' required type='text' id='FF_99902004' name='FF_99902004' value="<?php echo htmlspecialchars($form_data_a[99902004] ?? ''); ?>" placeholder=''>
                    </div>
					
                    <div class='col_100' id='SH_99902005_a' style='padding-left:5px'><div class='desc_f'>Call</div>
                        <textarea required id='FF_99902005' name='FF_99902005' style='height:0px;'><?php echo htmlspecialchars($form_data_a[99902005] ?? ''); ?></textarea>
                    </div>
					
                    <div class='col_a' id='SH_99902006_a'>
                        <div class='desc_f' >No-parse</div>
                    </div>
