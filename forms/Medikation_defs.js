...
const val_med_select2_a = [
    ["Anti-Durchfall Mittel", "Codein Tropfen|Codein Tabletten|Codein Trpf./ Tbl.|Imodium|Lopedium|Loperamid|Opium Tropfen|Paracodin Tropfen|andere Anti-Durchfall Mittel"],
    ["Biologika", "Amgevita (Adalimumab)|Cimzia (Certolizumab)|Entyvio (Vedolizumab)|Entyvio intravenös (Vedolizumab)|Entyvio subcutan (Vedolizumab)|Flixabi (Infliximab)|Fymskina (Ustekinumab)|Hukyndra (Adalimumab)|Hulio (Adalimumab)|Humira (Adalimumab)|Hyrimoz (Adalimumab)|Idacio (Adalimumab)|Imraldi (Adalimumab)|Imuldosa (Ustekinumab)|Inflectra (Infliximab)|Omvoh (Mirikizumab) - CU|Omvoh (Mirikizumab) - MC|Otulfi (Ustekinumab)|Pyzchiva (Ustekinumab)|Remicade (Infliximab)|Remsima (Infliximab) als Infusion|Remsima (Infliximab) als subcutan Spritze|Simponi (Golimumab)|Skyrizi (Risankizumab) - CU|Skyrizi (Risankizumab) - MC|Stelara (Ustekinumab)|Steqeyma (Ustekinumab)|Tremfya (Guselkumab) - CU|Tremfya (Guselkumab) - MC|Tysabri (Natalizumab)|Uzpruvo (Ustekinumab)|Wezenla (Ustekinumab)|Yuflyma (Adalimumab)|Yesintek (Ustekinumab)|Zessly (Infliximab)|unbekannt (Infliximab)|andere Biologika"],
    ["Budesonid", "Budenofalk (Budesonid oral)|Budenofalk uno (Budesonid oral)|Cortiment (Budesonid oral)|Entocort (Budesonid oral)|Budenofalkschaum (Budesonid rektal)|Entocort-Einläufe (Budesonid rektal)|Budesonid oral|Budesonid rektal|andere Budesonid"],
    ["Cortison-Präparate", "Prednisolon (Cortisonpräparat oral)|Decortin (Cortisonpräparat oral)|Decortin H (Cortisonpräparat oral)|andere Cortisonpräparate oral|Betnesol Klysmen (Cortisonpräparate rektal)|Colifoam Rektalschaum (Cortisonpräparate rektal)|Postericort (Cortisonpräparate rektal)|Cortison-Präparate oral|Cortison-Präparate rektal|andere Cortisonpräparate rektal"],
